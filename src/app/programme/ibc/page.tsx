...
export default function IBCProgrammePage() {
	return (
		<PageTemplate
			title="IBC"
			eyebrow="Programme"
			description="International Believers' Convergence — an annual convocation gathering believers for worship, teaching, and fellowship."
